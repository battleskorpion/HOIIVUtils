...
import com.HOIIVUtils.hoi4utils.clausewitz_map.Owner;
import com.HOIIVUtils.hoi4utils.clausewitz_map.UndefinedStateIDException;
import com.HOIIVUtils.hoi4utils.clausewitz_map.buildings.Infrastructure;
import com.HOIIVUtils.hoi4utils.clausewitz_map.province.VictoryPoint;
...
public class State implements InfrastructureData, Localizable, Iterable<State>, Comparable<State> {
	...
	private List<VictoryPoint> victoryPoints = null;
...
//				if (victoryPointsNode.value().list() != null) {
//					for (Node vpNode : victoryPointsNode.value().list()) {
//						victoryPoints.add(new VictoryPoint(vpNode.value().integer(), vpNode.nameAsInteger()));
//			todo: isssue: victory_points = {
//					701 30
//			}
//					}
//				}

//package main.java.com.HOIIVUtils.clauzewitz.script;
//
//import main.java.com.HOIIVUtils.clausewitz_parser.Node;
//import main.java.com.HOIIVUtils.clausewitz_parser.NodeValue;
...
//
//public class ListPDXScript<T extends PDXScript<?>> extends AbstractPDX<List<T>> implements Iterable<T> {
//    protected final Supplier<T> supplier;
//
//    public ListPDXScript(Supplier<T> supplier, @NotNull String... pdxIdentifiers) {
//        super(pdxIdentifiers);
//        this.supplier = supplier;
//        obj = new ArrayList<>();
//    }
//
//    public ListPDXScript(Supplier<T> supplier, @NotNull List<String> pdxIdentifiers) {
//        super(pdxIdentifiers);
//        this.supplier = supplier;
//        obj = new ArrayList<>();
//    }

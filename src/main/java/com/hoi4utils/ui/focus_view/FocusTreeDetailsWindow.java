//package main.java.com.HOIIVUtils.ui.focus_view;
//
//import main.java.com.HOIIVUtils.clauzewitz.data.focus.Focus;
//import main.java.com.HOIIVUtils.clauzewitz.localization.Localizable;
...
//		focusNameLabel = new Label(focus.localizationText(Localizable.Property.NAME));
...
//					details.append("- ");
//					details.append(f.localizationText(Localizable.Property.NAME));
//					details.append("\n");
//				}
//			} else {
//				details.append("Requires: ");
//				details.append(prereqSet.iterator().next().localizationText(Localizable.Property.NAME));
//				details.append("\n");
//			}
//		}
//

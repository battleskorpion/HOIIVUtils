 ...
 * buildingsTable.setDefaultRenderer(Integer.class, new
 ...
 * }
 * });
 * buildingsTable.setDefaultRenderer(Double.class, new
 * DefaultTableCellRenderer() {
 ...
 * String country_name = (String) buildingsTableModel.getValueAt(modelRow, 0);
 * // column 0 - country name
 * 
 * CountryTag country = new CountryTag(country_name);
 * 
 * CountryBuildingsByStateWindow countryBuildingsByStateWindow = new
 * CountryBuildingsByStateWindow(country);
 ...
 *//*
	 ...
	 * State.infrastructureOfStates(State.listFromCountry(country));
	 * Resources resources =
	 * State.resourcesOfStates(State.listFromCountry(country));
	 ...
	 * 
	 * // percentages
	 * buildingsTableModel.setValueAt((double)infrastructure.civilianFactories() /
	 * infrastructure.militaryFactories(), i, 6);
	 * buildingsTableModel.setValueAt((double)infrastructure.population() /
	 ...
	 * buildingsTableModel.setValueAt((double)infrastructure.population() /
	 * State.numStates(country), i, 11);
	 * 
	 * // resources
	 * if (aluminumDisplayAsPercentOption.isSelected()) {
	 * buildingsTableModel.setValueAt((double) resources.aluminum() /
	 ...
	 * buildingsTableModel.setValueAt((double) resources.chromium() /
	 ...
	 * buildingsTableModel.setValueAt((double) resources.oil() / resourcesAll.oil(),
	 * i, 14);
	 * } else {
	 * buildingsTableModel.setValueAt((double) resources.oil(), i, 14);
	 * }
	 * if (rubberDisplayAsPercentOption.isSelected()) {
	 * buildingsTableModel.setValueAt((double) resources.rubber() /
	 ...
	 * buildingsTableModel.setValueAt((double) resources.steel() /
	 ...
	 * buildingsTableModel.setValueAt((double) resources.tungsten() /
	 ...
	 * 
	 * if (table.getValueAt(row, column) != null && (Double) table.getValueAt(row,
	 * column) < min){

package main.java.com.hoi4utils.ui.buildings;
...
import main.java.com.hoi4utils.ui.javafx.export.ExcelExport;
import main.java.com.hoi4utils.ui.javafx.table.DoubleTableCell;
import main.java.com.hoi4utils.ui.javafx.table.IntegerOrPercentTableCell;
 ...
 * JCheckBoxMenuItem aluminumDisplayAsPercentOption = new
 * JCheckBoxMenuItem("Display Aluminum as Percent");
 * JCheckBoxMenuItem chromiumDisplayAsPercentOption = new
 * JCheckBoxMenuItem("Display Chromium as Percent ");
 * JCheckBoxMenuItem oilDisplayAsPercentOption = new
 * JCheckBoxMenuItem("Display Oil as Percent ");
 * JCheckBoxMenuItem rubberDisplayAsPercentOption = new
 * JCheckBoxMenuItem("Display Rubber as Percent ");
 * JCheckBoxMenuItem steelDisplayAsPercentOption = new
 * JCheckBoxMenuItem("Display Steel as Percent ");
 * JCheckBoxMenuItem tungstenDisplayAsPercentOption = new
 * JCheckBoxMenuItem("Display Tungsten as Percent ");
 * 
 * 
 ...
 * }
 * };
 * String[] columns = {"State", "Population", "Civilian Factories",
 * "Military Factories", "Dockyards", "Airfields",
 * "Civ/Mil Ratio", "Pop / Factory", "Pop / Civ Ratio", "Pop / Mil Ratio",
 * "Pop / Air Capacity", "Pop / State",
 ...
 * statesBuildingsTable.setDefaultRenderer(Integer.class, new
 ...
 * }
 * });
 * statesBuildingsTable.setDefaultRenderer(Double.class, new
 * DefaultTableCellRenderer() {
 ...
 * }
 * });
 * statesBuildingsTable.setDefaultRenderer(Float.class, new
 * DefaultTableCellRenderer() {
 ...
 *//*
	 ...
	 * String state_name = (String) stateBuildingsTableModel.getValueAt(modelRow,
	 * 0); // column 0 - country name
	 * 
	 ...
	 * stateBuildingsTableModel.setValueAt(infrastructure.civilianFactories(), i,
	 * 2);
	 * stateBuildingsTableModel.setValueAt(infrastructure.militaryFactories(), i,
	 * 3);
	 ...
	 * 
	 * // percentages
	 * stateBuildingsTableModel.setValueAt((double)infrastructure.civilianFactories(
	 * ) / infrastructure.militaryFactories(), i, 6);
	 * stateBuildingsTableModel.setValueAt((double)infrastructure.population() /
	 * (infrastructure.civilianFactories() + infrastructure.militaryFactories()), i,
	 * 7);
	 * stateBuildingsTableModel.setValueAt((double)infrastructure.population() /
	 * infrastructure.civilianFactories(), i, 8);
	 * stateBuildingsTableModel.setValueAt((double)infrastructure.population() /
	 * infrastructure.militaryFactories(), i, 9);
	 * stateBuildingsTableModel.setValueAt((double)infrastructure.population() /
	 * (infrastructure.airfields() * 200), i, 10);
	 * stateBuildingsTableModel.setValueAt((double)infrastructure.population() /
	 * State.numStates(countryTag), i, 11);
	 * 
	 * // resources
	 * if (aluminumDisplayAsPercentOption.isSelected()) {
	 * stateBuildingsTableModel.setValueAt((double) resources.aluminum() /
	 * resourcesAll.aluminum(), i, 12);
	 * } else {
	 * stateBuildingsTableModel.setValueAt((double) resources.aluminum(), i, 12);
	 * }
	 * if (chromiumDisplayAsPercentOption.isSelected()) {
	 * stateBuildingsTableModel.setValueAt((double) resources.chromium() /
	 * resourcesAll.chromium(), i, 13);
	 * } else {
	 * stateBuildingsTableModel.setValueAt((double) resources.chromium(), i, 13);
	 * }
	 * if (oilDisplayAsPercentOption.isSelected()) {
	 * stateBuildingsTableModel.setValueAt((double) resources.oil() /
	 * resourcesAll.oil(), i, 14);
	 * } else {
	 * stateBuildingsTableModel.setValueAt((double) resources.oil(), i, 14);
	 * }
	 * if (rubberDisplayAsPercentOption.isSelected()) {
	 * stateBuildingsTableModel.setValueAt((double) resources.rubber() /
	 * resourcesAll.rubber(), i, 15);
	 * } else {
	 * stateBuildingsTableModel.setValueAt((double) resources.rubber(), i, 15);
	 * }
	 * if (steelDisplayAsPercentOption.isSelected()) {
	 * stateBuildingsTableModel.setValueAt((double) resources.steel() /
	 * resourcesAll.steel(), i, 16);
	 * } else {
	 * stateBuildingsTableModel.setValueAt((double) resources.steel(), i, 16);
	 * }
	 * if (tungstenDisplayAsPercentOption.isSelected()) {
	 * stateBuildingsTableModel.setValueAt((double) resources.tungsten() /
	 * resourcesAll.tungsten(), i, 17);
	 * } else {
	 ...
	 * statesBuildingsTable.getColumnModel().getColumn(12);
	 ...
	 * statesBuildingsTable.getColumnModel().getColumn(13);
	 ...
	 * statesBuildingsTable.getColumnModel().getColumn(14);
	 ...
	 * statesBuildingsTable.getColumnModel().getColumn(15);
	 ...
	 * statesBuildingsTable.getColumnModel().getColumn(16);
	 ...
	 * statesBuildingsTable.getColumnModel().getColumn(17);
	 ...
	 * 
	 * // if (table.getValueAt(row, column) != null && (Double)
	 * table.getValueAt(row, column) < min){
	 * // cellComponent.setBackground(Color.YELLOW);
	 * // } else if (table.getValueAt(row, column) != null && (Double)
	 * table.getValueAt(row, column) >= max){

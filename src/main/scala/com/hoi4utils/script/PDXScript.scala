...
import com.hoi4utils.parser.{Node, NodeSeq, NodeValueType, PDXValueType}
 ...
 * @tparam V
 */
trait PDXScript[V, NodeValue <: NodeValueType] extends Cloneable with LazyLogging {
   ...
   */
  def loadPDX(expression: NodeType, file: Option[File]): Unit
   ...
   */
  def loadPDX(expressions: SeqNodeType): SeqNodeType

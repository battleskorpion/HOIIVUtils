...
import com.hoi4utils.hoi4mod.map.state.StateCategoryDefinition
 ...
 * @param id
 */
class StateCategory(id: String) extends ReferencePDX[StateCategoryDefinition](() => StateCategories.list, s => Some(s.name), id) {
  /* init */

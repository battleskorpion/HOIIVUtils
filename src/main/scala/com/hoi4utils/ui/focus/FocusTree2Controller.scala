...
class FocusTree2Controller extends HOIIVUtilsAbstractController2 with LazyLogging:
  ...
  @FXML private var focusTree2: AnchorPane = uninitialized
  @FXML private var toolBar: ToolBar = uninitialized
  @FXML private var focusTreeView: GridPane = uninitialized
  @FXML private var focusSelection: ScrollPane = uninitialized
  @FXML private var focusTreeScrollPane: ScrollPane = uninitialized
  @FXML private var lineLayer: Pane = uninitialized
  @FXML private var layeredContent: StackPane = uninitialized
  @FXML private var ft2SplitPane: SplitPane = uninitialized
  ...
  @FXML private var focusDetailsPane: AnchorPane = uninitialized
  @FXML private var focusDetailsPaneController: FocusDetailsPaneController = uninitialized
  @FXML private var focusTreesCount: Label = uninitialized
  @FXML private var progressIndicator: ProgressIndicator = uninitialized
  @FXML private var focusCountLabel: Label = uninitialized
  @FXML private var zoomInButton: Button = uninitialized
  @FXML private var zoomOutButton: Button = uninitialized
  @FXML private var resetZoomButton: Button = uninitialized
  @FXML private var gridlines: ToggleButton = uninitialized

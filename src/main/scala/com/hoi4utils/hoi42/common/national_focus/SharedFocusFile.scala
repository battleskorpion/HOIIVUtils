...
class SharedFocusFile(var sharedFocusFileRegistry: Registry[SharedFocusFile], var file: Option[File]) extends PDXEntity with Registry[SharedFocus] with RegistryMember[SharedFocusFile](sharedFocusFileRegistry) with Referable[String] {

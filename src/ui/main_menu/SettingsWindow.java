...
public class SettingsWindow extends Application {
	...
	*/
	...
	public void handleBrowseAction() {
		File selectedDirectory = HOIUtilsWindow.openChooser(idBrowseButton, HOIIVFile.hoi4mods_path, true); // ! im making this pass any class (that is a "Node" at least, bc that makes sense, something that can go on a fxwindow I think), much welcome :D

...
//            ideaFile.setLocalization(ideaLocFile);
...
//	    /* load idea loc */
//	    try {
//	        int numLocalizedIdeaes = FixIdea.addIdeaLoc(ideaTree, ideaLocFile);
//	        // todo didnt happe?
...
//                } else {
//                    Localization.Status textStatus = idea.getNameLocalization().status();
//                    Localization.Status descStatus = idea.getDescLocalization().status();
...
//            idea.setDescLocalization(event.getNewValue());
//        });
//    }
//
//

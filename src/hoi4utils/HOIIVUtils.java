...
public class HOIIVUtils {
	...
	public static void main(String[] args) {
		...
		if (firstTimeSetup) {
			System.out.println("HOIIVUtils created stage settings and lauched it cuz it was first time setup");
			...
			if (Settings.SKIP_SETTINGS.enabled()) {
				System.out.println("HOIIVUtils created stage menu and lauched it cuz settings was set to be skipped");
				menuController = new MenuController();
				menuController.launchMenuWindow(args);
			} else {
				System.out.println("HOIIVUtils created stage settings and lauched it cuz it was NOT first time and settings was NOT skipped");
				settingsController = new SettingsController();
				settingsController.launchSettingsWindow(args);
			}
		}

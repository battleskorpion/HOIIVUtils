...
public class heightmapfix {
    ...
    public static final int SEA_LEVEL = 45;

    public static void main(String[] args) throws IOException {
        heightmap = ImageIO.read(new File("src/temp/heightmap.bmp"));

        for (int x = 0; x < 4608; x++) {
            for (int y = 0; y < 2816; y++) {
        ...
        try {
            ImageIO.write(heightmap, "bmp", new File("src/temp/heightmap.bmp"));
        } catch (IOException e) {
